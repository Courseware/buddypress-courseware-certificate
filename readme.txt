=== BubbyPress Courseware Certificate ===
...
finishing all the assignments of a class.
...
If responses coverage is greater than 50% and no assignments left
user will receive an email with a diploma attached.
